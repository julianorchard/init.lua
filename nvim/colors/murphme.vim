...
" vim: tw=0 ts=4 sw=4
" Vim color file
" Maintainer: Julian Orchard <hello@julianorchard.co.uk>
" Last Change: Now

" Edited from the original Murphy colourscheme, maintained by Ron Aaron
...
hi Comment      term=bold          ctermfg=LightGrey    guifg=LightGray
